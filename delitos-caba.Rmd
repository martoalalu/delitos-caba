...
#Normalizo nombres para poder joinear
delitos_barrio$barrio[10] <- "COGHLAN"
delitos_barrio$barrio[15] <- "BOCA"
delitos_barrio$barrio[19] <- "MONSERRAT"
delitos_barrio$barrio[40] <- "VILLA GRAL. MITRE"
