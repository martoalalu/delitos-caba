...
calles_robos <- calles %>% 
  ...
  mutate(del_2016_m=del_2016/largo,
         del_2017_m=del_2017/largo,
         del_2018_m=del_2018/largo)
...
Calculamos la cantidad de delitos por metro en cada segmento de calle según tipo de delito y año. Lo normalizamos porque hay segmentos de calle que son muy largos (por ejemplo autopistas) que pueden distorisionar los datos.

```{r}
binpal <- colorBin("viridis", calles_hurtos$del_2016_m, 6, pretty = FALSE)
leaflet(calles_hurtos) %>% 
  addProviderTiles(providers$CartoDB.DarkMatter) %>% 
  addPolylines(color = ~binpal(del_2016_m), weight = 1.5, smoothFactor = 0.5, 
